# ProductNerve
ProductNerve is a Data Engineering pipeline that extracts, transforms and loads the Clickstream Data from the official data set made available by Zerve. Ai. This pipeline uses Python, SQL, Apache Spark (PySpark), Apache Airflow, Amazon S3 (Data Lake), Docker Snowflake, Tableau.
